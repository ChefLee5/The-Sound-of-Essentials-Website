...
const Home = () => {
  ...
  return (
    <div className="home-page">
      ...
      {/* ═══════════════════════════════════════════════════════
          SECTION 5.5: THE TRILINGUAL ACOUSTIC PATHWAY (EN · ES · FR)
      ═══════════════════════════════════════════════════════ */}
      <section className="section trilingual-section text-center glow-amber">
        <div className="container">
          <RevealSection className="text-center">
            <div className="section-label">{t('home.trilingual.tag')}</div>
            <h2 className="section-title">
              {t('home.trilingual.title_1')}{' '}
              <span className="text-orange">{t('home.trilingual.title_2')}</span>
            </h2>
            <p className="section-subtitle" style={{ maxWidth: '780px', margin: '0 auto 2.5rem auto' }}>
              {t('home.trilingual.subtitle')}
            </p>
            <div className="divider divider-center" />
          </RevealSection>

          <div className="trilingual-grid">
            {/* English Card */}
            <RevealSection delay={0.1}>
              <div className="glass-card trilingual-card trilingual-card--en">
                <div className="trilingual-card__header">
                  <span className="trilingual-card__flag">🇺🇸</span>
                  <span className="trilingual-card__badge">{t('home.trilingual.en_tag')}</span>
                </div>
                <h3 className="trilingual-card__title">{t('home.trilingual.en_title')}</h3>
                <div className="trilingual-card__track">
                  <span className="trilingual-card__track-icon">🎵</span>
                  <span className="trilingual-card__track-name">{t('home.trilingual.en_track')}</span>
                </div>
                <p className="trilingual-card__desc">{t('home.trilingual.en_desc')}</p>
                <div className="trilingual-card__quote">
                  “{t('home.trilingual.en_quote')}”
                </div>
              </div>
            </RevealSection>
            ...
            {/* Spanish Card */}
            <RevealSection delay={0.2}>
              <div className="glass-card trilingual-card trilingual-card--es">
                <div className="trilingual-card__header">
                  <span className="trilingual-card__flag">🇪🇸</span>
                  <span className="trilingual-card__badge">{t('home.trilingual.es_tag')}</span>
                </div>
                <h3 className="trilingual-card__title">{t('home.trilingual.es_title')}</h3>
                <div className="trilingual-card__track">
                  <span className="trilingual-card__track-icon">🎵</span>
                  <span className="trilingual-card__track-name">{t('home.trilingual.es_track')}</span>
                </div>
                <p className="trilingual-card__desc">{t('home.trilingual.es_desc')}</p>
                <div className="trilingual-card__quote">
                  “{t('home.trilingual.es_quote')}”
                </div>
              </div>
            </RevealSection>
            ...
            <RevealSection delay={0.3}>
              <div className="glass-card trilingual-card trilingual-card--fr">
                <div className="trilingual-card__header">
                  <span className="trilingual-card__flag">🇫🇷</span>
                  <span className="trilingual-card__badge">{t('home.trilingual.fr_tag')}</span>
                </div>
                <h3 className="trilingual-card__title">{t('home.trilingual.fr_title')}</h3>
                <div className="trilingual-card__track">
                  <span className="trilingual-card__track-icon">🎵</span>
                  <span className="trilingual-card__track-name">{t('home.trilingual.fr_track')}</span>
                </div>
                <p className="trilingual-card__desc">{t('home.trilingual.fr_desc')}</p>
                <div className="trilingual-card__quote">
                  “{t('home.trilingual.fr_quote')}”
                </div>
              </div>
            </RevealSection>
          </div>

          {/* Picture Dictionary Bridge Box */}
          <RevealSection delay={0.4}>
            <div className="trilingual-bridge glass-card">
              <div className="trilingual-bridge__icon">📚</div>
              <div className="trilingual-bridge__content">
                <h4 className="trilingual-bridge__title">{t('home.trilingual.dictionary_title')}</h4>
                <p className="trilingual-bridge__desc">{t('home.trilingual.dictionary_desc')}</p>
              </div>
            </div>

            <div className="trilingual-actions" style={{ marginTop: '2.5rem', display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link to="/listen" className="btn btn-gold btn-shimmer">
                {t('home.trilingual.cta_listen')}
              </Link>
              <Link to="/workbook#dictionary-presale" className="btn btn-outline">
                {t('home.trilingual.cta_dictionary')}
              </Link>
            </div>
          </RevealSection>
        </div>
      ...
      <style>{`
        ...
        /* ── SECTION 5.5: Trilingual Acoustic Pathway ── */
        .trilingual-section {
          padding: 6rem 0;
          position: relative;
        }
        ...
        .trilingual-card--en { border: 2px solid rgba(30, 136, 229, 0.25); }
        .trilingual-card--es { border: 2px solid rgba(255, 111, 0, 0.25); }
        .trilingual-card--fr { border: 2px solid rgba(156, 39, 176, 0.25); }

        .trilingual-card__header {
          display: flex;
          align-items: center;
          justify-content: space-between;
          margin-bottom: 1rem;
        ...
        .trilingual-card__flag {
          font-size: 2rem;
        }

        .trilingual-card__badge {
        ...
        .trilingual-bridge {
          ...
          border-radius: var(--radius-xl, 24px);
          background: linear-gradient(135deg, rgba(255, 255, 255, 0.98), rgba(255, 179, 0, 0.08));
        ...
        .trilingual-bridge__icon {
          font-size: 2.8rem;
          flex-shrink: 0;
        }

        .trilingual-bridge__title {
          font-family: var(--font-heading);
          font-size: 1.15rem;
          font-weight: 800;
